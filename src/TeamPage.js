...
const eboard = [
  {
    ...
    image: aliu,
    role: "President",
    description: "Albert majors in Computer Science at CAS. In the past, he's worked on Schedge, an API for NYU course data, as well as HumanToHuman, an application to help researchers study human interaction patterns. In his free time he enjoys going on long walks and taking longer naps.",
  },
  {
    name: "Samuel Lin",
    image: slin,
